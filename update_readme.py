...
# -*- coding: utf-8 -*-
"""
Actualizar README.md con instrucciones de Azure deployment
"""

readme_content = """# Azure AI-102 Evaluator Web App
...
print("[OK] README.md actualizado com instrucciones de Azure deployment")
